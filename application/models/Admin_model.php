...
class Admin_model extends CI_Model
{
	...
	// public function getNamaOrmawa($where)
    // {
        // if ($where != null) {
            // return $this->db->get_where('ormawa', $where)->result_array();
        // }
    // }

	public function getInfoPermintaan($table, $data = null, $where = null)
    {
        // if ($data != null) {
            // return $this->db->get_where($table, $data)->row_array();
        // } else {
        ...
        // }
		$this->db->select('*');
		$this->db->from('permintaanpembelian');
		$this->db->join('divisi','divisi.id_divisi=permintaanpembelian.divisi_id');
		$this->db->join('barang','barang.id_barang=permintaanpembelian.barang_id');
		$this->db->join('user','user.id_user=permintaanpembelian.user_id');
		$query = $this->db->get();
		return $query->result();
    }
	...
	public function getInfoUser($id)
    {
		$this->db->select('*');
		$this->db->from('user');
		$this->db->join('ormawa','ormawa.id_ormawa = user.id_ormawa');
	...
	public function getInfoBarangMasuk()
	...
	public function cariLaporan($id_barang)
	{	$id_barang = $this->input->get('id_barang');
		$this->db->select('*');
		$this->db->from('barang_masuk');
		$this->db->join('barang_keluar','barang_keluar.barang_id = barang_masuk.barang_id');
		$query = $this->db->where('barang_masuk.'.'barang_id', $id_barang);
		$query = $this->db->get();
		return $query->result();
