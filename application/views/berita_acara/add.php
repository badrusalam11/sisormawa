            ...
            <div class="card-body">
               ...
               <div class="row form-group" hidden >
				...
				<div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_BA">Nama Berita Acara</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            
                            <input name="nama_BA" id="nama_BA" type="text" class="form-control" placeholder="Nama Berita Acara...">
                        </div>
