            ...
            <div class="card-body">
               ...
               <div class="row form-group" hidden >
				...
				<div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_lpj">Nama LPJ</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            
                            <input name="nama_lpj" id="nama_lpj" type="text" class="form-control" placeholder="Nama LPJ...">
                        </div>
                        <?= form_error('nama_lpj', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
