    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_ormawa' => $ormawa['id_ormawa']]); ?>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_ormawa">Nama Ormawa</label>
                    <div class="col-md-9">
                        <div class="input-group">
                           
                            <input value="<?= set_value('nama_ormawa', $ormawa['nama_ormawa']); ?>" name="nama_ormawa" id="nama_ormawa" type="text" class="form-control" placeholder="Nama Ormawa...">
                        </div>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="sejarah" id="sejarah" class="form-control" rows="10" placeholder="Sejarah..."><?= set_value('sejarah', $ormawa['sejarah']); ?></textarea>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<textarea name="ad_art" id="ad_art" class="form-control" rows="10" placeholder="AD/ART..."><?= set_value('ad_art', $ormawa['ad_art']); ?></textarea>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<textarea name="gbho" id="gbho" class="form-control" rows="10" placeholder="GBHO..."><?= set_value('gbho', $ormawa['gbho']); ?></textarea>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<textarea name="gbhk" id="gbhk" class="form-control" rows="10" placeholder="GBHK..."><?= set_value('gbhk', $ormawa['gbhk']); ?></textarea>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<textarea name="struktur" id="struktur" class="form-control" rows="10" placeholder="Struktur..."><?= set_value('struktur', $ormawa['struktur']); ?></textarea>
