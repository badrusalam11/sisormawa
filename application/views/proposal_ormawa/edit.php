    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_proposal' => $proposal['id_proposal']]); ?>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_ormawa">Nama Proposal</label>
                    <div class="col-md-9">
                        <div class="input-group">
                           
                            <input value="<?= set_value('nama_proposal', $proposal['nama_proposal']); ?>" name="nama_proposal" id="nama_proposal" type="text" class="form-control" placeholder="Nama Ormawa..." readonly>
                        </div>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<option value="Diterima" <?php if($proposal['status']=="Diterima"){echo"selected";} ?> > Diterima</option>
							<option value="Revisi"<?php if($proposal['status']=="Revisi"){echo"selected";} ?> > Revisi</option>
							</select>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
							...
							<textarea name="catatan" id="catatan" class="form-control" rows="10" placeholder="Catatan..."><?= set_value('catatan', $proposal['catatan']); ?></textarea>
