...
<head>
	...
	<!-- calendar -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/calendar/bootstrap.calendar.css" type="text/css" />
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Sistem Informasi Ormawa</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('ProfileOrmawa'); ?>">
                    <span>Profile Ormawa</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('ProgramKerja'); ?>">
                    <span>Program Kerja Ormawa</span>
                </a>
            </li>
			
			<li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('ProposalOrmawa'); ?>">
                    <span>Proposal Kegiatan Ormawa</span>
                </a>
            </li>
			
			<li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('LpjOrmawa'); ?>">
                    <span>Laporan Pertanggungjawaban Kegiatan Ormawa</span>
                </a>
            </li>
			
			<li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('SkOrmawa'); ?>">
                    <span>SK Ormawa</span>
                </a>
            </li>
			
			<li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('BeritaAcara'); ?>">
                    <span>Berita Acara Ormawa</span>
                </a>
            </li>
            ...
            <div class="sidebar-heading">
             ...
             Nav Item - Dashboard
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('permintaanpembelian'); ?>">   
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('laporan'); ?>">
                    <span>Rekap Pengeluaran Kas</span>
                </a>
            </li>
             -->
    ...
    <!-- <script type="text/javascript" src="<?= base_url(); ?>assets/calendar/jquery.js" ></script> -->
	<!-- <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5/jquery.min.js"></script> -->

    <script type="text/javascript" src="<?= base_url(); ?>assets/calendar/bootstrap.js" ></script>
    <script type="text/javascript" src="<?= base_url(); ?>assets/calendar/bootstrap.calendar.js" ></script>
	<?php
						  $conn = mysqli_connect('localhost','root','','sisormawa');
						  $result = mysqli_query($conn, "SELECT * FROM proker");
              ...
              return {
                      "event":
                          [	<?php
							...
							if($no != $num)
							{
							  echo "{'date':" ."'". date("m/d/Y", strtotime($row['tanggal'])) ."'". ",'title':" ."'". $row['keterangan'] ."'". "}". ",";
							}
							else {
								echo "{'date':" ."'". date("m/d/Y", strtotime($row['tanggal'])) ."'". ",'title':" ."'". $row['keterangan'] ."'". "}";
							}
							...
							?>
                               // {"date":"08/11/2020","title":"Tes CPNS"}
							   // {'date':'08/11/20','title':'Musma HME'},{'date':'08/12/20','title':'Musma HMS '}
							   // {'date':'08/11/2020','title':'Musma HME'},{'date':'08/12/2020','title':'Musma HMS '}
                          ]
                      }
          };
