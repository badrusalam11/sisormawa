    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <br>
				<div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_ormawa">Ormawa</label>
                    <div class="col-md-9">
                        <div class="input-group">
							<select name="id_ormawa" id="id_ormawa">
							<?php foreach($ormawa as $r):?>
							<option value="<?= $r['id_ormawa']?>" <?php if($r['id_ormawa']==$user['id_ormawa']){echo "selected"; }?>><?= $r['nama_ormawa']?></option>
							<?php endforeach;?>
							</select>
